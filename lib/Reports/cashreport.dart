...
class CashPaymentReportPage extends StatelessWidget {
  final String customerName;
  final String customerPhone;
  final String paymentMethod;

  CashPaymentReportPage({
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Additional content specific to Cash Payment can be added here.
            Expanded(
              child: Center(
                child: Text(
                  'Details of the Cash payment report...',
